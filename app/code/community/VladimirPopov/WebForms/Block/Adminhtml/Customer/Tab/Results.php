    ...
    extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $collection = Mage::getModel('webforms/results')->getCollection()->addFilter('customer_id', $this->getRequest()->getParam('id'));
    ...
    {
        return $this->getUrl('webforms_admin/adminhtml_customer/results', array('id' => $this->getRequest()->getParam('id')));
    }
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('delete', array(
            ...
            'url' => $this->getUrl('webforms_admin/adminhtml_results/massDelete', array('customer_id' => $this->getRequest()->getParam('id'))),
        ...
        $this->getMassactionBlock()->addItem('email', array(
            ...
            'url' => $this->getUrl('webforms_admin/adminhtml_results/massEmail', array('customer_id' => $this->getRequest()->getParam('id'))),
        ...
        $this->getMassactionBlock()->addItem('status', array(
            ...
            'url' => $this->getUrl('webforms_admin/adminhtml_results/massStatus', array('customer_id' => $this->getRequest()->getParam('id'))),
            'additional' => array(
                'status' => array(
                    'name' => 'status',
                    'type' => 'select',
